    ...
    return (
        <div className="pt-20 flex flex-col" id="Contact">
            ...
            <div className="flex items-center justify-center mt-8 gap-4">
                <a href="https://www.linkedin.com/in/artyom-agadzhanyan-0779ba3a7/" target="_blank" className="w-6 opacity-50 transition-all duration-200 hover:opacity-100">
                ...
                <a href="https://t.me/artyomagadzhanyan" target="_blank" className="w-6 opacity-50 transition-all duration-200 hover:opacity-100">
                ...
                <a href="https://wa.me/+99362825833" target="_blank" className="w-6 opacity-50 transition-all duration-200 hover:opacity-100">
                ...
                <a href="mailto:artyom.dev250@gmail.com" className="w-6 opacity-50 transition-all duration-200 hover:opacity-100">
